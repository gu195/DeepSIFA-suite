...
def get_cfg(fold):
    ...
    parser.add_argument('--data_dir', type=str, default='D:/1DeepSIFA/data/mlkl/test/v1/归一化插值后npz_1024_高斯平滑1')
    parser.add_argument('--val_csv_dir', type=str, default='D:/1DeepSIFA/data/mlkl/test/v1/337.csv'.format(fold))
    parser.add_argument('--results_dir', default='./logs_test/', type=str, metavar='FILENAME',
