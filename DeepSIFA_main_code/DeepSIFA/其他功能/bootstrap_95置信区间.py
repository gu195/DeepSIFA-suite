...
# Load data set
# output_file_path = './logs_train verification/fold5/95 confidence.txt'
# data = pd.read_csv('./logs_train verification/fold5/score.csv')

# output_file_path = './logs_valverification/fold2/95confidence.txt'
# data = pd.read_csv('./logs_val verification/fold2/score.csv')
...
# Assume that y_test, y_pred, y_pred_proba and output_file_path are all defined
y_test = data['label']
y_pred = data['pre']    # Is it 1 or 0
y_pred_proba = data['pre']  # The specific probability of whether it is 1 or 0
