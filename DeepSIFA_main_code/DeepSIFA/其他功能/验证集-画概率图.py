...
input_file = './logs_val验证/fold{}/score.csv'.format(FOLD)
output_file = './logs_val验证/fold{}/score_distribution_{}.png'.format(FOLD,FOLD)
...
# definition file path
input_file = './logs_val验证/fold{}/score.csv'.format(FOLD)
output_file = './logs_val验证/fold{}/score_distribution_{}_good.png'.format(FOLD,FOLD)
...
# definition file path
input_file = './logs_val验证/fold{}/score.csv'.format(FOLD)
output_file = './logs_val验证/fold{}/score_distribution_{}_bad.png'.format(FOLD,FOLD)
