...
def get_cfg(fold):
    ...
    parser.add_argument('--data_dir', type=str, default='/home/node01/linchen/data/alphaK10/V2/汇总/1+2+3+4_292_模糊段/归一化插值后npz_1024_高斯平滑1')
    parser.add_argument('--val_csv_dir', type=str, default='/home/node01/linchen/data/alphaK10/V2/汇总/1+2+3+4_292_模糊段/292.csv')
    parser.add_argument('--results_dir', default='./logs_test模糊曲线/', type=str, metavar='FILENAME', help='Output csv file for validation results (summary)')
