...
def imshow(img, out_dir, name):
    # img is the output mask of the model 512 512
...
if __name__ == '__main__':
    ...
    with open(output_file_path2, 'w', newline='') as csvfile:  # Use newline='' to ensure newlines are handled properly in CSV
