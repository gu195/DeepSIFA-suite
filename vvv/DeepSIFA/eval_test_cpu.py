...
def get_cfg():
    ...
    parser.add_argument('--data_dir', type=str, default=os.path.join('data', 'MLKL', 'v1'))
    parser.add_argument('--results_dir', default=os.path.join('DeepSIFA', SAVE_LOG), type=str, metavar='FILENAME',
...
if __name__ == '__main__':
    ...
    if pretrained:#这一段要如何修改
        ...
        model_weights = torch.load(parse_config.weight_path, map_location=torch.device('cpu'))
    ...
    os.makedirs(parse_config.results_dir, exist_ok=True)  # 重新创建目录
